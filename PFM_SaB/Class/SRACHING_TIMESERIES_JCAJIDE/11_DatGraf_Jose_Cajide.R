...
#' Atención, no hace falta ponerle la variable Y, él entiende que 
#' si es histograma es un conteo de la variable X
...
#Dentro de "geom_..." podríamos mapear una función a todos los puntos, podríamos filtrar el dataset
#o incluso meter un nuevo dataset para aplicarle funciones especióficas.
