...
def report():
	...
	if voting_result >= threshold:
		...
		conclussion = "\n\n   So they resolved that the project should be studied to see if there is an alternative construction plan."
	else:
