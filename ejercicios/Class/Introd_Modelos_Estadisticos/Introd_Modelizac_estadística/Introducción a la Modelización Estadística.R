...
setwd("C:\Users\J.H\Documents\R_Practicas\AntonioPita")
...
modeloMuliple=lm(Income ~ Rating+Mortgage           , data = creditos)
summary(modeloMuliple)

anova(modeloInd1,modeloMuliple)
anova(modeloMuliple,modeloGlobal)
